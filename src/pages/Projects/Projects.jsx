                ...
                <Row>
                    <Col sx={4}>
                        <Card className='projects-card'>
                            <Card.Body>
                                <Card.Title style={{color:"rgba(3, 68, 136, 0.7)"}}>Coffee Page - Main Page</Card.Title>
                                <Card.Subtitle>
                                    <Row>
                                ...
                                <Card.Text 
                                style={{color:"rgba(116, 116, 116, 1)",marginTop:"1rem",fontWeight:"400",fontSize:"12px"}}>
                                ...
                                <Row>
                                        <Col style={{marginTop:"1rem",color:"rgba(3, 68, 136, 0.7)",fontSize:"16px",fontWeight:"400"}}>
                                            Progress
                                        </Col>
                                </Row>
                                <Row>
